 ...
 */
package com.yijiayiju.renovation.service.impl;
...
import com.yijiayiju.renovation.client.SmsClient;
...
import com.yijiayiju.renovation.common.profile.HttpProfile;
...
/**
 * @author yjl
 * @version $Id: sendMsgServiceImpl.java, v 0.1 2020-12-29 12:24 yjl Exp $$
 */
@Service
public class SendSmsServiceImpl implements SendSmsService {
    ...
    private SendSmsResponse sendSmsClient() throws TencentCloudSDKException {
        /* 必要步骤： TODO 后续要做全局异常处理机制，自定义注解
        ...
        SmsClient client = new SmsClient(cred, "ap-shandong",clientProfile);
        /* 实例化一个请求对象，根据调用的接口和实际情况，可以进一步设置请求参数
         * 你可以直接查询SDK源码确定接口有哪些属性可以设置
         * 属性可能是基本类型，也可能引用了另一个数据结构
         * 推荐使用IDE进行开发，可以方便的跳转查阅各个接口和数据结构的文档说明 */
        QSendSmsRequest req = new QSendSmsRequest();
        ...
        String[] phoneNumbers = {"+8617605437357"};
